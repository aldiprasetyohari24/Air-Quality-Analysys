...
PRSA_DataAvg_ModePerMonth = pd.read_csv("https://raw.githubusercontent.com/AldiPrasetyoHari/Air-Quality-Analysys/main/dashboard/PRSA_DataAvg_ModePerMonth.csv", sep=",", encoding="utf-8")
